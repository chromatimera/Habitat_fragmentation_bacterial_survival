...
filename = 'output/dropnr_1000_loading_rand_growth_binary_initialN_5_abconc_30_gr_0.01/initialN5_growthrate0.01_MIC1_totaldropnr1000_ABconc30_dt1_loadingrand_growthbinary.csv'
with open(filename) as x:
    ncols = len(x.readline().split(','))
binary_df = pd.read_csv(filename, usecols=range(1, ncols))
print('BINARY DF', binary_df)

binary_df_trp = binary_df.T
print('BINARY DF TRP', binary_df_trp)
